...
class XLerobot2Wheels(Robot):
    ...
    def __init__(self, config: XLerobot2WheelsConfig):
        ...
        self.bus2 = FeetechMotorsBus(
            ...
            motors={
                ...
                # [MODIFIED] Changed ID from 10 to 8 based on hardware scan
    ...
    def send_action(self, action: dict[str, Any]) -> dict[str, Any]:
        ...
        if self.config.max_relative_target is not None:
            ...
            goal_present_pos = {
                key: (g_pos, present_pos[key]) for key, g_pos in
                chain(left_arm_pos.items(), right_arm_pos.items(), head_pos.items())
            }
